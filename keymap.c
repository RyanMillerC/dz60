...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_RALT, KC_RGUI, MO(2), KC_NO, KC_NO, KC_RCTL
  ),
  ...
  LAYOUT(
    ...
    KC_TRNS, A(KC_F4), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
   ...
   * |RESET|     |     |     |     |     |     |     |     |     |     |     |     |        |
   * |--------------------------------------------------------------------------------------|
   * |      |RGB T| RGB | RGB | RGB | RGB | RGB | RGB | RGB |     |     |     |     |       |
   * |--------------------------------------------------------------------------------------|
   * |        |     |     |     |     |     |     |     |     |     |     |     |           |
   * |--------------------------------------------------------------------------------------|
   * |            |     |     |     |     |     |     |     |     |     |     |             |
